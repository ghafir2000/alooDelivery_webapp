...
class SMSModuleUpdateRequest extends FormRequest
{
    ...
    {
        // dd($this->all()); // <-- ADD THIS DEBUG LINE
        ...
        return [
            function (Validator $validator) {
                ...
                $validation = [
                    'gateway' => 'required|in:releans,twilio,nexmo,2factor,msg91,hubtel,paradox,signal_wire,019_sms,whatsapp,viatech,global_sms,akandit_sms,sms_to,alphanet_sms',
