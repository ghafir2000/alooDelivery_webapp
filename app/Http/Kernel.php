...
use App\Http\Middleware\LogoutConflictingGuards;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'verify-otp-admin' => \App\Http\Middleware\EnsureAdminOtpIsVerified::class, 
        ...
        'logout_conflicts' => LogoutConflictingGuards::class,
