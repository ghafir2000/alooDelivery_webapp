...
class SettingService
{
    ...
    public function getSMSModuleValidationData(object $request): array
    {
        ...
        $validation = [
            'gateway' => 'required|in:releans,twilio,nexmo,2factor,whatsapp,msg91,hubtel,paradox,signal_wire,019_sms,viatech,global_sms,akandit_sms,sms_to,alphanet_sms',
        ...
        } elseif ($request['gateway'] == 'whatsapp') {
            $additional_data = [
                'status'       => 'required|in:1,0',
                'api_url'      => 'required',
                'app_key'      => 'required',
