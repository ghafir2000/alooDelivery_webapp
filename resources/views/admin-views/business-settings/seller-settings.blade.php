                    ...
                    <div class="row align-items-end">
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label for="commission" class="title-color">{{ translate('default_sales_commission') }} (%)</label>
                                <input type="number" step="0.01" min="0" class="form-control" name="commission"
                                    value="{{ getWebConfig('sales_commission') ?? 0 }}">
                            </div>
                        </div>
