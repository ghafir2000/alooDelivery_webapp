                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="banner_type" class="title-color text-capitalize">
                                            {{ translate('banner_type') }}
                                        </label>
                                        <input type="hidden" name="banner_type" value="Main Banner">
                                        <div class="form-control">{{ translate('Main Banner') }}</div>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="url" class="title-color text-capitalize">{{ translate('banner_URL') }}</label>
                                ...
                                <div class="col-md-6 d-flex flex-column justify-content-center">
                                    <div>
                                        ...
                                        <label for="banner" class="title-color text-capitalize">
