...
use App\Http\Controllers\Admin\ExternalShopController;
...
Route::group(['prefix' => 'login'], function () {
    ...
    Route::post('/', [LoginController::class, 'login'])->middleware('logout_conflicts:admin')->name('login');
});
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    // Admin Authentication Routes
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        // OTP Verification Routes
        Route::get('otp-verification', 'OtpController@showOtpForm')->name('otp.view');
        Route::post('otp-verification', 'OtpController@verifyOtp')->name('otp.verify');
        Route::post('otp-resend', 'OtpController@resendOtp')->name('otp.resend');
    });
});


Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () { // add 'verify-otp-admin' to middlewares here so the otp for admin is active again , and change the admin auth otpController back to original state 
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.', 'middleware' => ['module:product_management']], function () {
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::get(Product::GET_CATEGORIES[URI], 'categoryList')->name('get-categories');
    ...
    Route::group(['prefix' => 'vendors', 'as' => 'vendors.', 'middleware' => ['module:user_section']], function () {
        Route::controller(VendorController::class)->group(function () {
            ...
            Route::get(Vendor::CATEGORY_LIST[URI] , 'categoryList')->name('category-list');
            Route::group(['prefix' => 'external-shops', 'as' => 'external-shops.'], function () {
                Route::get('/', [ExternalShopController::class, 'index'])->name('index');
                Route::get('add', [ExternalShopController::class, 'create'])->name('create');
                Route::post('store', [ExternalShopController::class, 'store'])->name('store');
                Route::get('edit/{id}', [ExternalShopController::class, 'edit'])->name('edit');
                Route::put('update/{id}', [ExternalShopController::class, 'update'])->name('update');
                Route::delete('delete/{id}', [ExternalShopController::class, 'destroy'])->name('destroy');
            });
        });
    ...
    Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.', 'middleware' => ['module:user_section']], function () {
        Route::controller(DeliveryManController::class)->group(function () {
            ...
            Route::get(DeliveryMan::TRACKING[URI], 'tracking')->name('tracking');            Route::get(DeliveryMan::ADD[URI], 'getAddView')->name('add');
...
Route::get('/driver-tracking', [DeliveryManController::class, 'showDriverTracking'])->name('driver.tracking');
