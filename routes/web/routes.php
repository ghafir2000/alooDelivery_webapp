...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    Route::group(['prefix' => 'product-compare', 'as' => 'product-compare.'], function () {
        Route::controller(ProductCompareController::class)->group(function () {
            Route::get(ProductCompare::INDEX[URI], 'index')->name('index')->middleware(['auth:customer', 'customer']);
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::controller(WebController::class)->group(function () {
        ...
        Route::get('wishlists', 'viewWishlist')->name('wishlists')->middleware(['auth:customer', 'customer']);
        ...
        Route::get('delete-wishlist-all', 'deleteAllWishListItems')->name('delete-wishlist-all')->middleware(['auth:customer', 'customer']);
    ...
    Route::controller(UserProfileController::class)->group(function () {
        Route::get('user-profile', 'user_profile')->name('user-profile')->middleware('auth:customer'); //theme_aster
        Route::get('user-account', 'user_account')->name('user-account')->middleware('auth:customer');
        Route::post('user-account-update', 'getUserProfileUpdate')->name('user-update')->middleware(['auth:customer', 'customer']);
        ...
        Route::get('account-oder', 'account_order')->name('account-oder')->middleware(['auth:customer', 'customer']);
        Route::get('account-order-details', 'account_order_details')->name('account-order-details')->middleware(['auth:customer', 'customer']);
        Route::get('account-order-details-vendor-info', 'account_order_details_seller_info')->name('account-order-details-vendor-info')->middleware(['auth:customer', 'customer']);
        Route::get('account-order-details-delivery-man-info', 'account_order_details_delivery_man_info')->name('account-order-details-delivery-man-info')->middleware(['auth:customer', 'customer']);
        Route::get('account-order-details-reviews', 'getAccountOrderDetailsReviewsView')->name('account-order-details-reviews')->middleware(['auth:customer', 'customer']);
        ...
        Route::get('refer-earn', 'refer_earn')->name('refer-earn')->middleware(['auth:customer', 'customer']);
        Route::get('user-coupons', 'user_coupons')->name('user-coupons')->middleware(['auth:customer', 'customer']);
        Route::get('user-restock-requests', 'restockRequestsView')->name('user-restock-requests')->middleware(['auth:customer', 'customer']);
        Route::get('user-restock-request-delete', 'deleteRestockRequest')->name('user-restock-request-delete')->middleware(['auth:customer', 'customer']);
        Route::get('user-all-restock-request-delete/{ids}', 'deleteAllRestockRequest')->name('user-all-restock-request-delete')->middleware(['auth:customer', 'customer']);
    });

    Route::controller(ChattingController::class)->group(function () {
        Route::get(Chatting::INDEX[URI] . '/{type}', 'index')->name('chat')->middleware(['auth:customer', 'customer']);
    ...
    Route::controller(UserWalletController::class)->group(function () {
        ...
        Route::get('wallet', 'index')->name('wallet')->middleware(['auth:customer', 'customer']);
    });

    Route::controller(UserLoyaltyController::class)->group(function () {
        Route::get(UserLoyalty::LOYALTY[URI], 'index')->name('loyalty')->middleware(['auth:customer', 'customer']);
...
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'namespace' => 'Web'], function () {
    Route::controller(CartController::class)->group(function () {
        ...
        Route::post('order-again', 'orderAgain')->name('order-again')->middleware(['auth:customer', 'customer']);
...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::controller(CustomerAuthController::class)->group(function () {
            ...
            Route::post('login', 'loginSubmit')->middleware('logout_conflicts:customer');
