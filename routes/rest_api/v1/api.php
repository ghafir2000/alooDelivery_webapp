...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
   ...
   Route::get('v1/categories/get', [CategoryController::class,'get_categories_by_type']);
                Route::get('/v1/categories/products/{category_id}', [CategoryController::class,'get_products']);
                Route::get('/v1/products/discounted-product', [ProductController::class,'get_discounted_product']);
                Route::get('/v1/products/best-sellings', [ProductController::class,'getBestSellingProducts']);
Route::post('/v1/calculate-distance', [OrderController::class, 'calculateDistance']);
