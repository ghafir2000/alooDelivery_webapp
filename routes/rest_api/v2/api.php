...
Route::group(['namespace' => 'RestAPI\v2', 'prefix' => 'v2', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'delivery-man', 'namespace' => 'delivery_man'], function () {
                Route::post('update-location', [DeliveryManController::class,'update_delivery_man_location']);
                Route::get('getDeliveryManLocation', [DeliveryManController::class,'getDeliveryManLocation']);
...
Route::get('/v2/delivery-man/getDeliveryManLocation', [DeliveryManController::class, 'getDeliveryManLocation']);
Route::get('/v2/settings/delivery-price-per-km', [OrderController::class, 'getDeliveryPricePerKm']);
Route::post('/v2/settings/delivery-price-per-km', [OrderController::class, 'updateDeliveryPricePerKm']);
